...
public class DemoRelaciones {
    ...
    private static final File JSON_COMERCIAL = new File("data","comerciales_export.json");
            ...
            while (true) {
                ...
                try {
                    switch (op) {
                        ...
                        case "16" -> listarComercial(sc);
                        case "17" -> insertarComercial(sc);
                        case "18" -> eliminarComercial(sc);

                        // ----------------- Repartidor ----------------
                        case "19" -> listarRepartidores();
                        case "20" -> listarRepartidor(sc);
                        case "21" -> insertarRepartidor(sc);
                        case "22" -> eliminarRepartidor(sc);

                        // ---------------- JSON EXPORT / IMPORT ------------
                        case "23" -> exportarJson();
                        case "24" -> importarJson();
                        case "25" -> exportarComercial();
                        case "26" -> importarComerciales();
    ...
    private static void mostrarMenu() {
        ...
        System.out.println("  16 - Listar comercial por id");
        System.out.println("  17 - Insertar comercial");
        System.out.println("  18 - Eliminar comercial");
        System.out.println();
        System.out.println("Repartidor");
        System.out.println("  19 - Listar repartidores");
        System.out.println("  20 - Listar repartidor por id");
        System.out.println("  21 - Insertar repartidor");
        System.out.println("  22 - Eliminar repartidor");
        System.out.println();
        System.out.println("JSON");
        System.out.println("  23 - Exportar BD a JSON");
        System.out.println("  24 - Importar JSON a BD (INSERT en orden FK)");
        System.out.println("  25 - Exportar Comerciales a JSON");
        System.out.println("  26 - Importar Comerciales desde JSON");
        System.out.println();
    ...
    public static void listarComercial(Scanner sc) throws SQLException{
        System.out.print("Indica un ID: ");
        int id = Integer.parseInt(sc.nextLine().trim());
        Comercial c = comercialDAO.findId(id);
        if(c != null){
    ...
    public static void insertarComercial(Scanner sc) throws SQLException {
        ...
        comercialDAO.insert(new Comercial(id, nombre, apellido));
    ...
    public static void eliminarComercial(Scanner sc) throws SQLException{
        ...
        System.out.println("Comercial eliminado.");
    }
    ...
    public static void listarRepartidor(Scanner sc) throws SQLException{
        System.out.print("Indica un ID: ");
        int id = Integer.parseInt(sc.nextLine().trim());
        Repartidor r = repartidorDAO.findId(id);
        if(r != null){
    ...
    public static void insertarRepartidor(Scanner sc) throws SQLException {
        ...
        System.out.print("Indica el apellido: ");
        apellido = sc.nextLine().trim();
        repartidorDAO.insert(new Repartidor(id, nombre, apellido));
    ...
    public static void exportarComercial() throws SQLException, IOException {
        ComercialesData data = new ComercialesData();
        data.setComerciales(comercialDAO.findAll());
        JsonIO.write(JSON_COMERCIAL, data);
        System.out.println("Exportado JSON en: " + JSON_COMERCIAL.getAbsolutePath());
    }
    ...
    private static void importarComerciales() throws SQLException, IOException{
        if (!JSON_COMERCIAL.exists()) {
            System.out.println("No existe el JSON: " + JSON_COMERCIAL.getAbsolutePath());
            return;
        }

        ComercialesData data = JsonIO.read(JSON_COMERCIAL, ComercialesData.class);
